...
func (s *strimziProvider) CreateTopics(app *crd.ClowdApp) error {
	...
	for _, topic := range app.Spec.KafkaTopics {
		...
		// fmt.Printf("Replica-list: %v", replicaValList)
		// fmt.Printf("Partition-list: %v", partitionValList)
